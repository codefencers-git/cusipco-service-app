...
class ThemeClass {
  ...
  static final Color gredientBlueColor4 = Color(0xFF317F9B);
  static final Color gredientBlueColor5 = Color(0xFF3B89A5);

  static final Color blueColorlight = Color(0xFF5D8B9C);

  static final Color blueColorlight2 = Color(0xFF5C9FB8);
  static final Color blueColorlight3 = Color(0xFFCEE2EA);
  static final Color blueColorlight4 = Color(0xFFE8F9FF);
  ...
  static final Color greyDarkColor2 = Color(0xFF3B3B3B);
  static final Color greyDarkColor3 = Color(0xFF6B6B6B);
